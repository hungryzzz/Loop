...
public class ListButtonCircleProgressBar extends ProgressBar{
    ...
    public ListButtonCircleProgressBar(Context context) {
        this(context,null);
    }

    public ListButtonCircleProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ListButtonCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
